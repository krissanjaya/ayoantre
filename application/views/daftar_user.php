...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/daftar_user.css">
	 ...
	 <nav class="navbar navbar-expand-lg navbar-light fixed-top nav-pad-20" id="mainNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <a href="<?php echo base_url();?>masuk" class="btn-how3">MASUK</a>
            </div>
        </div>
    </nav>

    <section id="daftar" style="">
    <div class="container">
            ...
            <div class="col-md-4" style="margin-top: auto;margin-bottom: auto; display: block;">
                <div class="caption">
                    ...
                    <div class="button-daftar">
                        <a href="<?php echo base_url();?>/#services" class="btn-how3" style="width:100%;">DAFTAR</a>
                    </div>
                </div>
            </div>
            <div class="col-md-8">
